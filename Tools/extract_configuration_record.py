...
def decode_configuration(config_str):
    """
    Decodes the Configuration JSON string and processes its fields, 
    handling specific attributes based on their expected structure.
    ...
    try:
        ...
        # Check for and process specific attributes
        for attribut_key in ["ListOfDevices", "PluginConf", "CoordinatorBackup"]:
...
def fetch_hardware_records(database_path):
    """
    ...
    try:
        ...
        for record in records:
            ...
            # Decode the Configuration field
            configuration = decode_configuration(config_str)
...
fetch_hardware_records('domoticz.db')
